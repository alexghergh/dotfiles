...
name: Handoff File
interaction: chat
description: Write a self-contained implementation brief for a brand-new session to a file.
opts:
  alias: handoff-file
  auto_submit: false
  is_slash_cmd: true
...
The brief content must be markdown. Include exactly these sections, in this order:
